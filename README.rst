...
Второе применение это связка python + _`selenium`: http://www.seleniumhq.org/ позволила сделать простую обработку 
...
Основной код располагается в модуле _`PipeRunner.Pas`:https://github.com/WorldException/v7SimpleAddIn/blob/master/v7AddIn/PipeRunner.pas
